 ...
 *
*/
#define MATRIX_ROW_PINS {  9, 10, 11, 12 }
#define MATRIX_COL_PINS { 20, 19, 18, 17, 16, 15, 14 }
#define MATRIX_LAYOUT \
    { 1,  2,  3,  4,  5,  6,             13, 12, 11, 10,  9,  8,    0, \
     15, 16, 17, 18, 19, 20,             27, 26, 25, 24, 23, 22,    0, \
     29, 30, 31, 32, 33, 34,    7, 14,   41, 40, 39, 38, 37, 36,    0, \
              45, 46, 47, 48, 35,21,49, 55, 54, 53, 52,             255}
